...
contract("ProjectListing", async ([owner, user1, user2]) => {
  ...
  it("should list all projects", async () => {
    await contractInstance.listProject("Demo project1", "Demo pitch1", "Demo description1", "Demo logo1", "Demo website1", "Demo category1", "Demo tags1", "Demo image1", {from : user1});
    await contractInstance.listProject("Demo project2", "Demo pitch2", "Demo description2", "Demo logo2", "Demo website2", "Demo category2", "Demo tags2", "Demo image2", {from : user2});
